...
def pad(plaintext):
    ...
    # print(f"plaitext with padding: {(plaintext + padding).hex()}")
...
class AES:
    ...
    def encrypt(self, plaintext:bytes):
        ...
        for plaintext_block in split_blocks(plaintext):
            ciphertext_blocks.append(self.encrypt_block(plaintext_block))
        return b''.join(ciphertext_blocks)
    
    def decrypt(self, ciphertext:bytes):
        plaintext_blocks = []
        for ciphertext_block in split_blocks(ciphertext):
            plaintext_blocks.append(self.decrypt_block(ciphertext_block))
    ...
    def decrypt_cbc(self, ciphertext, iv:bytes):
        """
